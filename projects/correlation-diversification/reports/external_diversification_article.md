...
The pattern is clear: while partially driven by the same sterling weakness that inflated GBP equity figures, wine's EUR-adjusted return of +5% demonstrates that underlying collector demand provided a genuine independent contribution - one that equities, on the same currency-adjusted basis, failed to match.
...
The COVID crash in March 2020 saw global equity markets fall 30–35% in weeks. Fine wine indices showed materially smaller drawdowns — the Liv-ex 1000 returned approximately +2% in GBP terms over the February–April 2020 window while individual wines ranged from −8% (Domaine de la Romanée-Conti, Échezeaux) to flat (Salon, LWIN7: 1807626) to +11% (Lafite, LWIN7: 1011872) — and recovered their losses faster as institutional and private collector demand held up through the crisis.
...
Our analysis of specific high-profile wines — Salon Blanc de Blancs (LWIN7: 1807626, all vintages), Domaine de la Romanée-Conti, Échezeaux (LWIN7: 1028658, all vintages), and Château Lafite-Rothschild (LWIN7: 1011872, all vintages) — shows strikingly different price trajectories during market stress periods. During the 2008 GFC, individual wines showed a wide return range: Salon −11%, Échezeaux −15%, and Lafite −16% over the September 2008–March 2009 window. During the COVID shock (February–April 2020), dispersion widened further — Salon was flat (0%), Échezeaux fell −8%, while Lafite gained +11%. In the 2022 rate-rise cycle, all three outperformed the Liv-ex 100 (−0.2%): Salon +8%, Échezeaux +15%, Lafite +1%.

![Individual Wine Price Series](../images/heterogeneity/wine_price_series.png)
*Price histories for Salon (LWIN7: 1807626), Domaine de la Romanée-Conti, Échezeaux (LWIN7: 1028658), and Lafite (LWIN7: 1011872) (GBP per 750ml, volume-weighted; all vintages aggregated). Stress periods shaded. The divergence in individual wine price paths illustrates why asset selection within fine wine is as important as the allocation decision itself.*
